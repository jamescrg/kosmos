...
urlpatterns = [
    ...
    path(
        "files/filter/importance/<int:importance_value>/",
        files_filter_importance,
        name="files-filter-importance",
    ),
    ...
    path(
        "documents/highlights/filter/importance/<int:importance_value>/",
        highlights_filter_importance,
    ...
    path(
        "documents/timeline/filter/importance/<int:importance_value>/",
        timeline_filter_importance,
    ...
    # Search subapp
    path("documents/search/", search_index, name="search-index"),
    path("documents/search/list/", search_list, name="search-list"),
    path("documents/search/results/", search_results, name="search-results"),
    path("documents/search/query/", search_query, name="search-query"),
    path("documents/search/filter/", search_filter, name="search-filter"),
    path(
        "documents/search/filter/type/",
        search_filter_type,
        name="search-filter-type-clear",
    ),
    path(
        "documents/search/filter/type/<str:result_type>/",
        search_filter_type,
        name="search-filter-type",
    ),
    path("documents/search/clear/", search_clear, name="search-clear"),
]
