...
def _get_invoicing_dates(invoice: Invoice) -> tuple:
    """
    Given an invoice, return an invoicing start and end date
...
def _format_line(
    ...
    earliest_date, latest_date = _get_invoicing_dates(invoice)
